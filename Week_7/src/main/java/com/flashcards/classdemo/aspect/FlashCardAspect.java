...
//	}
//
	@Before("execution(* com.flashcards.classdemo.controller.ImaginaryFriendController.*(..))")
	public void hijackImaginaryController(JoinPoint jp) {
	...
	@Around("execution(* com.flashcards.classdemo.service.ImaginaryFriendService.*(..))")
	public void hijackImaginaryService(ProceedingJoinPoint pjp) {
